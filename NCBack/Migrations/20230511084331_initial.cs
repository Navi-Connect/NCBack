        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Знакомства и встречи молодежи" },
                    { 5, "Встреча верующих людей" },
                    { 6, "Для родителей (Прогулка с детьми)" },
                    { 7, "Спорт, тренировки, игры" },
                    { 8, "Обсуждение фильма/сериала/книги" },
                    { 9, "Обсуждение идеи/бизнеса (брейншторм)" },
                    { 10, "Совместный заработок" },
                    { 11, "Прогулка с животными" },
                    { 12, "Встреча людей с ограниченными возможностями" },
                    { 13, "Совместная выпивка" },
                    { 14, "Встреча болельщиков, фанатов" },
                    { 15, "Съемки контента" },
                    { 16, "Танцы" },
                    { 17, "Разговор по душам" },
                    { 18, "Только девушки" },
                    { 19, "Практика языков" },
                    { 20, "Консультации специалистов" },
                    { 21, "Саморазвитие, обучение" },
                    { 22, "Творчество и изобразительное искусство" },
                    { 23, "Совместное путешествие, туризм" },
                    { 24, "Рыбалка и охота" },
                    { 25, "Послушать/записать музыку" },
                    { 26, "Встреча туристов/иностранцев" },
                    { 27, "Другое" }
                });
