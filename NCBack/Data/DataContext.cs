...
public class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AimOfTheMeeting>().HasData(
            ...
            new { Id = 2, NameAimOfTheMeeting = "Совместный отдых" },
            new { Id = 3, NameAimOfTheMeeting = "Встреча взрослых людей" }, 
            new { Id = 4, NameAimOfTheMeeting = "Знакомства и встречи молодежи" },
            new { Id = 5, NameAimOfTheMeeting = "Встреча верующих людей" }, 
            new { Id = 6, NameAimOfTheMeeting = "Для родителей (Прогулка с детьми)" },
            new { Id = 7, NameAimOfTheMeeting = "Спорт, тренировки, игры" }, 
            new { Id = 8, NameAimOfTheMeeting = "Обсуждение фильма/сериала/книги" },
            new { Id = 9, NameAimOfTheMeeting = "Обсуждение идеи/бизнеса (брейншторм)" }, 
            new { Id = 10, NameAimOfTheMeeting = "Совместный заработок" },
            new { Id = 11, NameAimOfTheMeeting = "Прогулка с животными" }, 
            new { Id = 12, NameAimOfTheMeeting = "Встреча людей с ограниченными возможностями" },
            new { Id = 13, NameAimOfTheMeeting = "Совместная выпивка" }, 
            new { Id = 14, NameAimOfTheMeeting = "Встреча болельщиков, фанатов" },
            new { Id = 15, NameAimOfTheMeeting = "Съемки контента" }, 
            new { Id = 16, NameAimOfTheMeeting = "Танцы" },
            new { Id = 17, NameAimOfTheMeeting = "Разговор по душам" }, 
            new { Id = 18, NameAimOfTheMeeting = "Только девушки" },
            new { Id = 19, NameAimOfTheMeeting = "Практика языков" }, 
            new { Id = 20, NameAimOfTheMeeting = "Консультации специалистов" },
            new { Id = 21, NameAimOfTheMeeting = "Саморазвитие, обучение" }, 
            new { Id = 22, NameAimOfTheMeeting = "Творчество и изобразительное искусство" },
            new { Id = 23, NameAimOfTheMeeting = "Совместное путешествие, туризм" }, 
            new { Id = 24, NameAimOfTheMeeting = "Рыбалка и охота" },
            new { Id = 25, NameAimOfTheMeeting = "Послушать/записать музыку" }, 
            new { Id = 26, NameAimOfTheMeeting = "Встреча туристов/иностранцев" },
            new { Id = 27, NameAimOfTheMeeting = "Другое" }
        );
        base.OnModelCreating(modelBuilder);
